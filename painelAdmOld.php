...
<!-- Mirrored from htmldemo.hasthemes.com/alexis/alexis/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Apr 2021 22:19:46 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="wrapper home-default-wrapper">
        ...
        <div class="main-search-active">
            ...
            <div class="sidebar-search-input">
                ...
                <p class="form-description">Pressione ENTER para procurar</p>
            </div>
        </div>
        <!-- Main Search End -->
        ...
        <footer class="footer-area reveal-footer border-top-style ">
            <div class="container-fluid ">
                ...
                <p>© 2021 <span>Alexis</span>. Made with <i class="icofont-heart-alt "></i> by <a target="_blank "
                    href="https://www.hasthemes.com/ ">HasThemes</a></p>
              </div>-->
                            </div>
                            <div class="widget-item ">
                                <ul class="widget-social ">
                                    <li class="social-text "><span>nossas redes sociais</span></li>
        ...
        <aside class="off-canvas-wrapper ">
            <div class="off-canvas-inner ">
              ...
              <li class="dropdown-submenu " id="submenuTwo ">
                ...
                <ul class="dropdown-nav collapse " id="collapseTwo " aria-labelledby="submenuTwo " data-bs-parent="#assideMenuNav ">
